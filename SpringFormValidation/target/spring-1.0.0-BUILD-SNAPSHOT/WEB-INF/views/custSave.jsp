...
<body>
	...
	<springForm:form method="POST" commandName="addressForm"
		action="save.do">
		<table>
			<tr>
				<td>Main Address:</td>
				<td><springForm:input path="mainAddress" /></td>
				<td><springForm:errors path="mainAddress" cssClass="error" /></td>
			</tr>
			<tr>
				<td>Other Address:</td>
				<td><springForm:input path="otherAddress" /></td>
				<td><springForm:errors path="otherAddress" cssClass="error" /></td>
			</tr>
			<tr>
				<td colspan="3"><input type="submit" value="Save Address"></td>
			</tr>
